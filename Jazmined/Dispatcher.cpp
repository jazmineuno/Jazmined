...
// file COPYING or http://www.opensource.org/licenses/mit-license.php#include "stdafx.h"
...
namespace System {
	...
	void Dispatcher::dispatch() {
		...
		for (;;) {
			...
			ULONG actual = 0;
			if (GetQueuedCompletionStatusEx(completionPort, &entry, 1, &actual, timeout, TRUE)) {
